...
const { createCredentialsBridgeHandlers, registerCredentialsIpc } = await import("../src/credentialsBridge.js");
const { CREDENTIALS_CHANNELS } = await import("../src/credentialsChannels.js");
